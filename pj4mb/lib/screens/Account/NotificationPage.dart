        ...
        appBar: AppBar(
          ...
          actions: [
            TextButton(onPressed: (){
              setState(() {
                widget.listNotification.forEach((element) {
                  element.read = true;
                });
              });
                ...
                return Container(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      var result = await NotificationService().UpdateNotification(notification);
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            notification.message + " - " + DateFormat("dd-MM-yyyy HH:mm:ss").format(notification.timestamp) ,
