...
class ListCategoryTransaction extends StatelessWidget {
  const ListCategoryTransaction({super.key, required this.listCategory, required this.categoryType, required this.onSave});
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              children: [
                GestureDetector(
                  onTap: () async {
                    Navigator.pop(context,new Category(categoryID: cate.categoryID,name: cate.name,icon: cate.icon, CategoryType: CateTypeENum.DEBT, user: 0));
                  },
                  child: Container(
